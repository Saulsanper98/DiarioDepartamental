...
import {
  ...
  dismissNotesOnboarding,
  onNotesSearchHistoryChange,
  setNoteView,
  setNoteViewCalendar,
  exitNotesCalendarToList,
...
import {
  ...
  selectVisibility,
  toggleReminder,
  syncReminderSummaryFromInput,
  onNotesSaveSoundPrefChange,
  ...
  ncalNavigateMonth,
  ncalGoToday,
  ncalOpenNewNoteForDay,
  ncalOpenGoToDate,
  switchNoteModalTab,
  handleNoteTitleInput,
  refreshNoteTagsChipsFromInput,
  syncNoteTagsDatalist,
  toggleNotesExportMenu,
  toggleNotesTopbarOverflowMenu,
  filterNotesByAuthorFromCard,
  clearNotesAuthorFilter,
  applyNotesListSort,
  requestCloseNoteModal,
  openNotesShortcutsHelpModal,
  announceNotes,
...
import {
  ...
  openMyWorkTasksView,
  exitMyWorkTasksView,
  dismissProjectsOnboarding,
  openProjectsShortcutsModal,
  toggleProjectActionsMenu,
  setProjectActivityFilter,
  toggleProjectStatsCompactLayout,
  projectToolbarPickSort,
  projectToolbarPickView,
  kanbanColDragOver,
  kanbanColDragLeave,
  closeTaskRowMenu,
  toggleProjectTaskMultiselect,
  toggleProjectTaskSelect,
  clearProjectTaskMultiselect,
  batchMarkSelectedTasksDone,
  openAddTaskModalWithColumn,
  ...
  toggleProjectTaskListDensity,
  filterProjectsTreeSearch,
  toggleProjectsListDrawer,
  toggleProjectsTreeCollapsed,
  applyProjectsDeepLinkFromHash,
  dismissProjectRemoteStaleBanner,
  setMyWorkGroupMode,
  loadMoreProjectTasksPage,
  batchApplyAssigneeToSelection,
  batchApplyDueToSelection,
  batchApplyPriorityToSelection,
  closeTaskViewerModal,
  onCalTaskRowDragStart,
  onProjectCalMonthDragOver,
  onProjectCalMonthDragLeave,
  onProjectCalMonthDrop,
  toggleProjectDetailOnlyMine,
  toggleKanbanSwimlane,
  projectModalWizardNext,
  projectModalWizardPrev,
  syncProjectModalWizardStep,
  syncProjectModalStickyName,
  copyTaskViewerDeepLink,
  toggleProjectPresentationMode,
...
import {
  ...
  exportProjectTasksJSON,
  copyProjectSummaryMarkdown,
...
async function initApp(appUser) {
  ...
  setTimeout(() => {
    if (typeof window.applyProjectsDeepLinkFromHash === 'function' && window.applyProjectsDeepLinkFromHash()) {
      /* Vista proyectos restaurada desde enlace #/projects/... */
